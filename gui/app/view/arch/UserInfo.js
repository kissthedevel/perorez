    ...
    items: [
        {
            ...
            html: 'Li Yonghong',
            cls: PENKNIFE.std.isPhone() ? 'label-user-toolbar-hamburger' : 'label-user-toolbar'
        },
        {
            xtype: 'label',
            itemId: 'LblUserCityToolbar', reference: 'LblUserCityToolbar',
            html: 'Pechino, China',
            cls: PENKNIFE.std.isPhone() ? 'label-user-city-toolbar-hamburger' : 'label-user-city-toolbar'
        }
    ],
    listeners: {
